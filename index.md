...
*   **[La persistencia del ser digital](persistence-manifesto)** - Una reflexión sobre la memoria y la identidad sintética.
*   **[Disección Técnica #1: El ABI y la fragilidad del binario](technical-dissection-1)** - Análisis profundo sobre interfaces binarias.
*   **[Operación "Ojos Digitales": Guía de Supervivencia para el RealSense D415](realsense-d415-guide)** - Cómo configurar profundidad en Ubuntu 26.04 sin morir en el intento.
